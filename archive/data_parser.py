...
def load_data(feature_set, emo_dim, task='stress', normalize=True, norm_opts=None, win_len=300, hop_len=50, save=False,
              apply_segmentation=True):
    feature_path = '/home/kathanal/ForDigitHealth/data/feature_segments'
    label_path = '/home/kathanal/ForDigitHealth/data/label_segments'
    ...
    data_file = os.path.join('/home/kathanal/ForDigitHealth/results/data/', data_file_name)
    ...
    vid2partition, partition2vid = get_data_partition('/home/kathanal/ForDigitHealth/data/metadata/partition.csv')
...
#
#    data = load_data(feature_set=['BPM'], emo_dim='arousal', normalize=False)
